...
exports.policyContent = exports.mode = exports.requiredTagKeys = exports.supportedServiceCount = exports.policyArn = exports.policyName = exports.policyId = void 0;
...
const requiredTags = config.getObject("requiredTags") || {
...
exports.policyId = tagPolicy.id;
exports.policyName = tagPolicy.name;
exports.policyArn = tagPolicy.arn;
exports.supportedServiceCount = SUPPORTED_SERVICES.length;
exports.requiredTagKeys = Object.keys(requiredTags);
exports.mode = enforcementMode;
exports.policyContent = pulumi.output(JSON.stringify(tagPolicyContent, null, 2));
